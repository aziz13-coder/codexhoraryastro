...
const EnhancedChartView = ({ chart, darkMode, notes, setNotes }) => {
  ...
  // Confidence Bar Component with animated progress
  const ConfidenceBar = ({ judgment, confidence, darkMode }) => {
    ...
    // Debug: Let's start with a simpler, more visible version
    const progressWidth = animatedConfidence;
    const thumbPosition = Math.min(Math.max(progressWidth - 4, 4), 96); // Keep thumb visible
    ...
    return (
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          {/* Progress Bar Container - Simplified for debugging */}
          <div className="relative w-60 h-6 bg-gray-200 dark:bg-gray-700 rounded-full">
            {/* Fill Bar - Now with fixed positioning */}
            <div 
